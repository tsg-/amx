...
<div class="page-wrap">
    <table width="100%">
        <tr>
        <td width="200" align="center" rowspan=2 colspan=2><img src="/static/intel-logo.jpg" width="200" class="rounded" alt="Intel Logo"></td>
        <td align="center" valign="top"><h1 style="margin-bottom:4px;"><b style="font-size:1.4em;">AMX&#8482; DEMO</b></h1></td>
        <td width="200" align="center" rowspan=2 colspan=2><img src="/static/vLLM-logo.jpg" width="200" class="rounded" alt="vLLM Logo"></td>
        <tr>
        <td align="center" valign="top" style="color: #00FFFF">Built-in AI Inference <i>without</i> a GPU<p></td>
        <tr>
        <td colspan=4 align="center"><b style="font-size:1.8em;">Live demonstration of Intel&reg; <U>A</U>dvanced <U>M</U>atrix e<U>X</U>tensions running vLLM</b></td>
        <tr>
        </tr>
        <td colspan=4>
                <table border=1 style="margin:8px auto 0 auto; font-size:1.05em; border-collapse:collapse;">
                    <tr>
                        <td style="text-align:right; padding:2px 8px 2px 0; white-space:nowrap; width:160px;"><b>Model in use:</b></td>
                        <td style="text-align:left; padding:2px 0; color:#00FFFF; white-space:nowrap;">&nbsp; {{ model }} &nbsp;</td>
                    </tr>
                    <tr>
                        <td style="text-align:right; padding:2px 8px 2px 0; white-space:nowrap;"><b>CPU under Test:</b></td>
                        <td style="text-align:left; padding:2px 0; color:#00FFFF; white-space:nowrap;">&nbsp; {{ cpu }} &nbsp;</td>
                    </tr>
                </table>
        </td>
    </table>
    ...
    <div class="controls" style="margin: 0 auto;">
        <div class="ctrl-group"> 
            ...
            <select id="question" style="width:532px">
